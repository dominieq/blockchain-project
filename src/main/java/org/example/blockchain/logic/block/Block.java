...
/**
 * The {@code Block} is a simple implementation of a block concept that is a part of {@code BlockChain}.
 ...
 *     <li>magic number.</li>
 * </ol>
 * If a block is first in a blockchain it's {@code previousHash} value is equal to "0".
 *
